...
-(id)initWithFrame:(CGRect)frame imageName:(NSString *)name
{
    if(self = [super initWithFrame:frame])
    {
        ...
        _phoneFlowImageView1 = [[UIImageView alloc] initWithImage : [UIImage imageNamed:@"op1.jpg"]];
        ...
        _phoneFlowImageView2 = [[UIImageView alloc] initWithImage : [UIImage imageNamed:@"op2.jpg"]];
        ...
        _phoneFlowImageView3 = [[UIImageView alloc] initWithImage : [UIImage imageNamed:@"op6.jpg"]];
