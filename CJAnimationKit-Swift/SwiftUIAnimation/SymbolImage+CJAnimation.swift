//
//  Image+CJSymbolAnimation.swift
//  CJAnimationKitDemo
//
//  Created by qian on 2024/12/15.
//
//  本类 iOS 18+ SF Symbol。且实际上没必要封装。此处封装的唯一场景是有服务器情况下，后台通过字符串枚举，对应到本类。
//  使用示例：
//    Image(systemName: "heart.fill")
//        .resizable()
//        .applyEffect(selectedEffect)  // 等价于 .symbolEffect(.bounce.up.byLayer, options: .repeat(.continuous))
